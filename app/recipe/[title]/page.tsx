...
export default function Page({ params }: PageParams) {
  ...
  "Stek alltsammans på medelvärme tills löken brynts och körv o potatis fått färg.","Gör något mer skojigt med maten.","Lägg den på en tallrik vetja, passa på att lägga lite bestick och ett glas på bordet också.",
"Servera med stekt ägg och inlagda rödbetor."],
tags: ["korv", "ris"],
imageUrl: 'https://fastly.picsum.photos/id/92/3568/2368.jpg?hmac=k-61p7oMQe6U59dEgm0Gu6bWTJGPfHblWxMskxTBZMo'
  }
  return (
